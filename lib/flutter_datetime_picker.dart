  ...
  static Future<DateTime?> showDatePicker(
    ...
    return await Navigator.push(
      ...
      _DatePickerRoute(
        ...
        locale: locale,
        theme: theme,
        barrierLabel: mat.MaterialLocalizations.of(context).modalBarrierDismissLabel,
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  ...
  @override
  Color get barrierColor => mat.Colors.black54;
  ...
  AnimationController createAnimationController() {
    ...
    _animationController = mat.BottomSheet.createAnimationController(navigator!.overlay!);
